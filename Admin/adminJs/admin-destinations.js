...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const lkrPriceInput = document.getElementById("lkrPrice");
    const safetyInput = document.getElementById("safety");
    const featuredInput = document.getElementById("featured");
    const usdPriceCustomInput = document.getElementById("usdPriceCustom");
const lkrPriceCustomInput = document.getElementById("lkrPriceCustom");

if (usdPriceInput) {
    usdPriceInput.addEventListener("change", () => {
        usdPriceCustomInput.style.display = usdPriceInput.value === "custom" ? "block" : "none";
    });
}

if (lkrPriceInput) {
    lkrPriceInput.addEventListener("change", () => {
        lkrPriceCustomInput.style.display = lkrPriceInput.value === "custom" ? "block" : "none";
    });
}
...
function setPriceField(selectEl, customEl, value) {
    ...
    const matchesOption = Array.from(selectEl.options).some(opt => opt.value === stringValue);
    ...
    if (form) {
        ...
        form.addEventListener("submit", async (e) => {
            ...
            usdPrice: resolvePrice(usdPriceInput, usdPriceCustomInput),
lkrPrice: resolvePrice(lkrPriceInput, lkrPriceCustomInput),
            ...
            try {
                ...
                usdPriceCustomInput.value = "";
usdPriceCustomInput.style.display = "none";
lkrPriceCustomInput.value = "";
lkrPriceCustomInput.style.display = "none";
        ...
        document.querySelectorAll(".destination-table .edit").forEach(button => {
            ...
            button.onclick = async function () {
                ...
                try {
                   ...
                   setPriceField(usdPriceInput, usdPriceCustomInput, dest.usdPrice);
setPriceField(lkrPriceInput, lkrPriceCustomInput, dest.lkrPrice);
